...
do
	cd 
	f_cls
	f_dsplyPos  1  24 $faGras$fcJaune 'Langage->'$name_src$faGras$fcGreen' - Project: '$faGras$fcCyan' Zcrypt'


	f_dsplyPos  6  24 $faGras$fcJaune '------------compile Zig-----------------'
	f_dsplyPos  7  20 $faGras$fcRouge'11.'; f_dsplyPos  7  24 $faGras$fcGreen 'crypt'
...
#etudes
		11)
#			/home/soleil/.Terminal/dispatch.sh $envZIG $LIBPROJECT   "etude"
		;;
#study 
        20)
			/home/soleil/.Terminal/dispatch.sh $envZIG  $LIBPROJECT   "crypt"	
